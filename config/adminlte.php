...
return [
    ...
    */
    ...
    'logo' => '<b>Agendamento</b>',
    'logo_img' => 'assets/img/logo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Agendamento',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Agenda',
            'url'  => 'admin/agendas/index',
            'icon' => 'fas fa-fw fa-calendar',
        ],
        [
            'text' => 'Agendamento',
            'url'  => 'admin/agendamentos/index',
        ...
        'MeusScripts' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/mask/jquery.mask.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/meus_scripts.js',
                ],
            ],
        ],
    ],
